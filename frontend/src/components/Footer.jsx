    ...
    <div className='footer' id='footer'>
        <div className="footer-content">
            <div className="footer-content-left">
                <img src={logo} alt=""/>
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Tempora, cumque ratione. Nihil corporis, eos ratione, obcaecati voluptates ex similique hic qui rerum numquam ad quisquam consequuntur labore quasi quis nobis?</p>
